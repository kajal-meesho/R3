...
class IntToRomanTest {
    ...
    // Additional representative values from code review feedback
    ...
    @Test void testThrowsOutOfRangeLow() {
        assertThrows(IllegalArgumentException.class, () -> IntToRoman.intToRoman(0));
    }

    @Test void testThrowsOutOfRangeHigh() {
        assertThrows(IllegalArgumentException.class, () -> IntToRoman.intToRoman(4000));
    }
}